/**
 * Draws the dash trails held in `dashTrail.js` — the "Ion Streak" of `design-system.md` §8.
 *
 ...
 * one of the fixed strings the caller passes in — the same rule the boid glow table follows.
 */
...
/** Half width at the object: the player's radius, and roughly a boid's half length. */
const PLAYER_RIBBON_HALF = 15;
const BOID_RIBBON_HALF = 8;
 ...
 * @param {import('./dashTrail.js').DashTrails} trails - The history to draw.
